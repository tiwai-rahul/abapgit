CLASS zcl_populate_travel_data DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_populate_travel_data IMPLEMENTATION.
METHOD if_oo_adt_classrun~main.

    DATA itab TYPE TABLE OF ztravel_app_db.
...
*   delete existing entries in the database table
    DELETE FROM ztravel_app_db.

*   insert the new table entries
    INSERT ztravel_app_db FROM TABLE @itab.
